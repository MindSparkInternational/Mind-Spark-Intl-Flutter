...
class SignUpTwo extends StatefulWidget {
  ...
  @override
  _SignUpTwoState createState() =>
      _SignUpTwoState(firstName, lastName, password);
}
                ...
                Column(
                  children: <Widget>[
                    FadeAnimation(
                        1,
                        Text(
                          "Welcome to Mind Spark, $firstName",
                    ...
                    FadeAnimation(
                        1.2,
                        Text(
                          "We just need a bit more information about before we continue",
                          textAlign: TextAlign.center,
                          style:
                          ...
                          child: MaterialButton(
                            onPressed: () async {
                              var response = await http.post(
                                  "https://mindsparkapi.herokuapp.com/api/v1/registration/",
                                  body: {
