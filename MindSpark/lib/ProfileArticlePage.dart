...
class ProfileArticleScreen extends StatefulWidget {
  String title;
  String author;
  String body;
  String subHead;
  ...
  List<dynamic> medias;
  String profImg;
  ProfileArticleScreen({this.profImg,this.medias,this.title, this.author, this.body, this.fields, this.likes, this.comments,this.subHead, this.date, this.id, this.diffUser});
  @override
  _ProfileArticleScreenState createState() => _ProfileArticleScreenState(profImg:profImg,medias:medias,diffUser:diffUser,title: title, author: author, body: body, fields: fields, likes: likes, comments: comments, subHead: subHead, date: date, id: id);
}

class _ProfileArticleScreenState extends State<ProfileArticleScreen> {
  String title;
  String author;
  String body;
  String date;
  ...
  List<Comment> comments;
  bool isSaved = false;
 _ProfileArticleScreenState({this.profImg,this.medias,this.diffUser,this.title, this.author, this.body, this.fields, this.likes, this.comments,this.subHead,this.date, this.id});
