import 'package:MindSpark/ProfileArticlePage.dart';
...
class ProfileArticleCard extends StatefulWidget {
  String title;
  String author;
  String body;
  String subHead;
  ...
  String authorId;
  List<dynamic> medias;
  ProfileArticleCard({this.profImg,this.inSecond,this.diffUser,this.title, this.author, this.body, this.fields, this.likes, this.comments, this.date,this.subHead, this.medias, this.id, this.authorId});
  @override
  _ProfileArticleCardState createState() => _ProfileArticleCardState(profImg:profImg,inSecond:inSecond,diffUser:diffUser,authorId: authorId,title: title, author: author, body: body, fields: fields, likes: likes, medias: medias,comments: comments, date: date,subHead:subHead, id: id);
}

class _ProfileArticleCardState extends State<ProfileArticleCard> {
  String title;
  String author;
  String profImg;
  String body;
  ...
  _ProfileArticleCardState({this.profImg,this.inSecond,this.diffUser,this.title,this.authorId, this.author, this.body, this.fields, this.likes, this.comments, this.date,this.subHead, this.medias, this.id});
                              ...
                              Padding(
                                ...
                                child: LayoutBuilder(builder:
                                  ...
                                  return GestureDetector(
                                   ...
                                   return ProfileArticleScreen(profImg:profImg,medias:medias,likes: likes,diffUser: diffUser,title: title,body: body,author: author,date: date, subHead:subHead, comments: comments, fields: fields, id: id,);
                                      }));
                                    },
                                    child: Container(
