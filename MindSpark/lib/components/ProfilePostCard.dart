...
class ProfilePostCard extends StatefulWidget {
  ...
  bool inSecond = false;
  DiffUser diffUser;
  ProfilePostCard({this.profImg,this.inSecond,this.diffUser,this.title, this.author, this.body, this.fields, this.likes, this.comments, this.date, this.medias, this.id});
  @override
  _ProfilePostCardState createState() => _ProfilePostCardState(profImg:profImg,inSecond:inSecond,diffUser:diffUser,title: title, author: author, body: body, fields: fields, likes: likes, comments: comments, date: date, medias: medias, id:id);
}
...
class _ProfilePostCardState extends State<ProfilePostCard> {
  ...
  List<dynamic> medias;
  List<Comment> comments;
  _ProfilePostCardState({this.profImg,this.inSecond,this.diffUser,this.title, this.author, this.body, this.fields, this.likes, this.comments, this.date, this.medias, this.id});
  String sampletext =
